...
<template>
    <div class="space-y-4">
            ...
            <div class="space-y-3">
                <div>
                    ...
                    <input
                        ...
                        type="text"
                        placeholder="ej: enviar_mensaje_usuario"
                ...
                <ExpandableTextarea
                    ...
                    placeholder="Usa esta herramienta para enviar un mensaje al usuario mientras procesas la solicitud..."
                    :rows="2"
        ...
        <div>
            ...
            <select
                v-model="localConfig.toolMessageType"
        ...
        <ExpandableTextarea
            v-model="localConfig.toolMessageContent"
            label="Contenido por defecto (el agente puede sobrescribir)"
            placeholder="ej: Estoy buscando la información, un momento..."
            :rows="2"
            modal-title="Mensaje por defecto" />
        ...
        <div
            ...
            Permite al agente enviar mensajes intermedios al usuario
            <strong>durante</strong>
            el loop agentic, antes de dar la respuesta final.
        </div>
    </div>
</template>
