<script setup lang="ts">
    ...
    const clearSelection = () => {
        localConfig.value.internalFunctionName = '';
        localConfig.value.internalFunctionParams = {};
    };
...
<template>
    <div class="space-y-4">
        <div
            ...
            <p>Las funciones internas son métodos predefinidos del backend que puedes ejecutar dentro del flujo.</p>
        </div>
                                    ...
                                    <button
                                        ...
                                        <div class="flex items-start gap-2">
                                            <div class="flex-1 min-w-0">
                                                ...
                                                <div
                                                    v-if="fn.parameters && fn.parameters.length > 0"
                                                    class="flex flex-wrap gap-1 mt-1">
                                                    <span
                                                        v-for="param in fn.parameters.slice(0, 3)"
                                                        :key="param.name"
                                                        class="px-1.5 py-0.5 text-[10px] bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 rounded">
                                                        {{ param.name }}
                                                    </span>
                                                    <span
                                                        v-if="fn.parameters.length > 3"
                                                        class="px-1.5 py-0.5 text-[10px] bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400 rounded">
                                                        +{{ fn.parameters.length - 3 }} más
                                                    </span>
                                                </div>
                                            </div>
                                            <svg
